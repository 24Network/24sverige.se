						...
						<div class="row" style="margin-bottom: 45px;">
							...
							<div class="col-sm-5">
								<div class="contact-us-box">
									...
									<div class="box-right">
										<?php if ( $email ): ?>
											<span class="box-right-row"><?php _e( 'E-post:', 'illdy' ); ?>
												<a href="mailto:<?php echo esc_attr( $email ); ?>" title="<?php echo esc_attr( $email ); ?>"><?php echo esc_html( $email ); ?></a></span>
										<?php endif; ?>
										<?php if ( $phone ): ?>
											<span class="box-right-row" data-customizer="contact-us-phone"><?php _e( 'Telefon:', 'illdy' ); ?> <?php echo illdy_sanitize_html( $phone ); ?></span>
										<?php endif; ?>
									</div><!--/.box-right-->
								</div><!--/.contact-us-box-->
							</div><!--/.col-sm-5-->
